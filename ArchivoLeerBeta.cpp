...
// int main(){
//     // for (int i=10; i<=25; i++){
//     //     int nivelfinal = ceil((log10(pow(2,  i)) / log10(M)))+1 ;
//     //     cout << "Altura arbol "<< i <<": " << nivelfinal << endl;
//     // }

//     //Definimos una función que nos permita saber cuántos nodos hay en el nivel actual
//     int M = 1024;
//     for (int factor = 10; factor<=25; factor++){
//         for (int nivel = 1; nivel <=(ceil((log10(pow(2,  factor)) / log10(M)))+1 ); nivel++){
//             cout << "Factor: "<< factor
//             << "\nNivel: "<< nivel+1
//             << "\nNivel Máximo: " << ceil((log10(pow(2,  factor)) / log10(M))) + 1
//             << "\nNodos por leer: "<<  nodosporleerF(factor, nivel, M) << endl << endl;
